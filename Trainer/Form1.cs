...
namespace Trainer
{
    public partial class Trainer_Form : MetroForm
    {
        ...
        public void ToggleOption(CheckBox Checkbox, Key Key)
        {
        ...
        private void BGWorker_ProgressChanged(object sender, System.ComponentModel.ProgressChangedEventArgs e)
        {
            if (ProcOpen)
            {
                ...
                ToggleOption(Infinite_Health, Key.NumPad1);
                ToggleOption(Infinite_Ammo, Key.NumPad2);
                ToggleOption(No_Damage, Key.NumPad3);
                ToggleOption(Jump, Key.NumPad4);
